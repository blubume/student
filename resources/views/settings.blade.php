      ...
      <div class="row">
        <div class="col-md-12 owner">
          <ul class="nav nav-tabs tabMenu">
            ...
            <li><a href="#about_us" data-toggle="tab">О себе</a></li>
            <li><a href="#password" data-toggle="tab">Сменить пароль</a></li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-4 col-md-offset-1">
              <div style="position:relative;" class="block column">
                <div class="block-title">АВАТАР</div>
                <div class="block-content">
                  <div class="avatar-profile"><img src="/img/avatar.jpg" class="avatarPhoto"></div>
                  <div class="button-save-avatar">
                    <button id="avatarButton" type="button" style="margin-top:40px;padding: 15px 40px; font-size: 14px;font-family:'LatoLight'" class="btn btn-danger">ИЗМЕНИТЬ</button>
                ...
                <div class="block-content">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="nickname">ИМЯ(НИКНЕЙМ)</label>
                        <input id="nickname" type="text" placeholder="" class="input-guest form-control">
                      </div>
                      <div class="form-group">
                        <label for="brithday">ДАТА РОЖДЕНИЯ</label>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label for="repeat-new-password">ПОКАЗЫВАТЬ ВОЗРАСТ</label>
                        <div class="radio-button">
                          <div class="item left active">Показывать</div>
                          <div class="item right">Не показывать</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div style="text-align:center;" class="col-md-12">
                      <button type="button" style="margin-top:60px;padding: 15px 40px; font-size: 14px;font-family:'LatoLight'" class="btn btn-danger">ИЗМЕНИТЬ</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="block-content">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label for="brithday">ИНТЕРЕСЫ</label>
                    ...
                    <div class="col-md-6">
                      <div id="drop-lang-level" class="form-group dropdown drop-menu">
                        <label for="email">УРОВЕНЬ</label>
                        <div id="langLevel" style="text-align:center;cursor:pointer;display:block;width:100%;" data-toggle="dropdown" class="input-guest form-control dropdown-toggle">Средний</div>
          ...
          <div class="row">
            <div class="col-md-4 col-md-offset-4">
              <div style="padding-left: 40px;padding-right: 40px;" class="block">
                <div class="block-title">СМЕНИТЬ ПАРОЛЬ</div>
                <div style="text-align:center;border-radius 40px;" class="block-content">
                  ...
                  <div class="form-group">
                    <label for="repeat-new-password">ЕЩЕ РАЗ</label>
                    <input id="repeat-new-password" type="password" placeholder="" class="input-password form-control">
                  </div>
                  <button type="button" style="margin-top:40px;padding: 15px 40px; font-size: 14px;font-family:'LatoLight'" class="btn btn-danger">ИЗМЕНИТЬ</button>
                </div>
              </div>
            </div>
          </div>
